...
function App() {
  ...
  //Defino el state para el presupuesto y otro state para el restante de presupuesto
  const [presupuesto, guardarPresupuesto] = useState(0);
  const [restante, guardarRestante] = useState(0);
  //Defino el siguiente state para mostrar o no diferentes componentes
  const [mostrarPregunta, actualizarPregunta] = useState(true);
  //Para agregar los gastos a un listado
